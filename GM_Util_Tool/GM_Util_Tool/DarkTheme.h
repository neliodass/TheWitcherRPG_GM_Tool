...
public:
	...
	QString buttonAvatar() { return commonButtonStyle + "QPushButton { padding: 5px; }"; }
	QString buttonCharacter() { return commonButtonStyle; }
	QString buttonTeam() { return commonButtonStyle + "QPushButton { margin: 1px 1px; padding-left: 6px; }"; }
	...
	QString normalInput() {
		return "QLineEdit { color: #000000;font-family: Berylium; font-weight:bold; font-size: 14px; " + inputField + "}";
	}
	QString comboBoxInput() {
		return "QComboBox { color: #000000; font-family: Berylium; font-weight:bold; font-size: 14px; padding-left: 2px; " + inputField + "}"
